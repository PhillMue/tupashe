...
import com.crazyhitty.chdev.ks.tupashe.models.LibraryItem;
import com.crazyhitty.chdev.ks.tupashe.models.SettingsPreferences;
import com.crazyhitty.chdev.ks.tupashe.ui.adapters.LibrariesRecyclerViewAdapter;
...
public class AboutActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_rate) {
            ...
            intent.setData(Uri.parse("market://details?id=com.crazyhitty.chdev.ks.tupashe"));
